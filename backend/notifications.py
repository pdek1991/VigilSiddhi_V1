...
WS_URL = "ws://127.0.0.1:8000" # Ensure this is a plain string, not a tuple
TELEGRAM_BOT_TOKEN = "YOUR_TELEGRAM_BOT_TOKEN_HERE" # REMOVE THIS FOR PRODUCTION, USE ENV VARS
